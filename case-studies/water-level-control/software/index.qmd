...
![PanelView 800 HMI interface developed in Connected Components Workbench for process visualization and operator interaction.](../software-hmi.png){fig-alt="PanelView 800 HMI interface for water-level process visualization and operator interaction" width="95%"}
